...
@implementation FJCoreDataStack

#pragma mark singleton implementation

static FJCoreDataStack* _shared = nil;

+(FJCoreDataStack*)shared{
    @synchronized([FJCoreDataStack class])
    {
        if(!_shared)
...
+(id)alloc
{
    @synchronized([FJCoreDataStack class])
    {
        NSAssert(_shared == nil, @"Attempted to allocate a second instance of the FJCoreDataStack singleton");
        _shared = [super alloc];
        return _shared;
    }
    return nil;
