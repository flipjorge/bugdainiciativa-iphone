...
-(void)populateDatabase
{
    ...
    if( ![[NSFileManager defaultManager] fileExistsAtPath:[[FJCoreDataStack shared] storePath]] ){
        /*
        [Evento generateEventoWithTitle:@"Evento 1" content:@"Content 1" link:@"http://www.bugdainiciativa.com" id:@"http://bugdainiciativa.com/?p=407" imageLink:@"http://bugdainiciativa.com/wp-content/themes/diarise/functions/510x200xthumb.php,qsrc=wp-content,_uploads,_2012,_04,_2012-04-27_1625.png,aw=510,ah=200,azc=1,aq=90.pagespeed.ic.jpV6Q6JMRI.png" location:@"Lisboa" startDate:[NSDate date] endDate:[NSDate dateWithTimeIntervalSinceNow:60*60*2]];
